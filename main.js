...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" title="HuiZi v2.4.4"/>
                <tabs id="tabs"/>
            </appbar>
...
//设置滑动页面的标题
ui.viewpager.setTitles(["自动", "数据配置", "运行日志"]);
//让滑动页面和标签栏联动
...
ui.click_me.on("click", ()=>{
    toast("选择此APP开启无障碍");
    engines.execScript("选择此APP开启无障碍","auto.waitFor();console.show();console.hide();");
});
